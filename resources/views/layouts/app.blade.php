...
<head>
    ...
    <!-- Page head script Start-->
    @yield('script')
    <!-- Page head script End-->
...
<body>
            ...
            <nav>
                <div class="nav-div">
                    <div class="home-content">
                        <i class='hamburger bx bx-menu'></i>
                    </div>
                ...
                <div class="sub-menu-wrap" id="profile-sub-menu">
                    <div class="profile-sub-menu">
                        ...
                        <a href="#" class="profile-sub-menu-link">
                            <img src="{{ asset('assets/images/profile/logincurve.svg') }}" alt="">
                            Edit Profiles
                        </a>
                        <a href="#" class="profile-sub-menu-link">
    ...
    <!-- Page foot script Start -->
    @yield('script')
    <!-- Page foot script End -->
